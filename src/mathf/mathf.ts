 ...
 * @tested
 */
export function absZero(value: number) {
 ...
 */
export function fixDigits(value: string | number, digits: number): number {
 ...
 * @param {number} digits The number of digits to output.
 */
export function int0(value: number): number {
  return value >> 0;
}
 ...
 */
export function getUniqueRandomInt(
  min: number,
  max: number,
  not: number
): number {
 ...
 */
export function angleRadians(x1: number, y1: number, x2: number, y2: number) {
 ...
 */
export function angleDegree(x1: number, y1: number, x2: number, y2: number) {
 ...
 */
export function angleDistanceDegree(
  angle0: number,
  angle1: number,
  max?: number
) {
 ...
 */
export function angleDistanceRadian(
  angle0: number,
  angle1: number,
  max?: number
) {
 ...
 */
export function boxCollision(a: box, b: box) {
  return !(
    a.y + a.height < b.y ||
    a.y > b.y + b.height ||
    a.x + a.width < b.x ||
 ...
 */
export function collisionCircVsBox(circ: circ, rect: box) {
 ...
 */
export function collisionPointVersusConvexPolygon(
  point: point,
  poly: Array<point>
): boolean {
 ...
 * @tested
 */
export function calculate2dPointRotation(
  cx: number,
  cy: number,
  x: number,
  y: number,
 ...
 *     new coordinates to.
 */
export function calculate2dPointRotationWithDistance(
  cx: number,
  cy: number,
  x: number,
  y: number,
 ...
 * @tested
 */
export function direction(previous: number, current: number): number {
  if (previous === current) {
    return 0;
  }
 ...
 */
export function calculateCenterOffset(parent: number, child: number): number {
 ...
 * ````
 */
export function scaleX(x1: number, y1: number, y2: number): number {
  return (x1 * y2) / y1;
}
 ...
 * ````
 */
export function scaleY(x1: number, y1: number, x2: number): number {
  return (x2 * y1) / x1;
}
 ...
 */
export function aspectRatio(box: dimensionalBox): number {
 ...
 * @tested
 */
export function resizeDimensionalBoxToWidth(
  box: dimensionalBox,
  width: number
): dimensionalBox {
  return {
 ...
 * @tested
 */
export function resizeDimensionalBoxToHeight(
  box: dimensionalBox,
  height: number
): dimensionalBox {
  return {
 ...
 */
export function clampAsPercent(percent: number) {
 ...
 */
export function clampAsProgress(progress: number) {
 ...
 * @return progress A value within 0-1.
 */
export function clamp01(progress: number) {
  return clampAsPercent(progress);
}
 ...
 */
export function getValueInRangeByProgress(
  progress: number,
  min: number,
  max: number
): number {
 ...
 */
export function getProgressInRangeByValue(
  val: number,
  min: number,
  max: number
): number {
 ...
 * @untested
 */
export function mix(a: number, b: number, blend: number) {
 ...
 * ```
 */
export function step(edge: number, n: number) {
  if (n > edge) {
    return 1.0;
  } else {
    return 0.0;
 ...
 */
export function smoothStep(min: number, max: number, input: number): number {
 ...
 * @param time
 */
export function sinNormalized(time: number): number {
 ...
 */
export function calculateBackgroundCover(
 ...
 * @param childBox
 */
export function calculateBackgroundContain(
  parentBox: dimensionalBox,
  childBox: dimensionalBox
): number {
 ...
 * @param amount
 */
export function asymptoticAverage(
  current: number,
  target: number,
  amount: number
): number {
 ...
 */
export function smoothStart2(t: number): number {
  return t * t;
}
 ...
 */
function smoothStop2(t: number): number {
  return 1 - (1 - t) * (1 - t);
}
 ...
 * Implements basic smooth start.  See EASE for more.
 */
export function smoothStart3(t: number): number {
  return t * t * t;
}
 ...
 * ```
 */
export function smoothStep2(value: number, mix: number, t: number): number {
 ...
 * @param mix
 */
export function sigmoid(value: number, mix: number) {
