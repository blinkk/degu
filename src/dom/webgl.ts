...
export class webgl {
     ...
     */
    static createProgram(gl: WebGLRenderingContext, vs: string, fr: string): WebGLProgram {
        // Create program
     ...
     * @param source
     */
    static createTextureFromImage(gl: WebGLRenderingContext, image: HTMLImageElement): WebGLTexture {
