...
/**
 * A string value that is a CSS color value constant.
 *
 * ```ts
 * is.cssColorName('blue') // true
 * is.cssColorName('Gandalf') // false
 * ```
 */
export function cssColorName(value: any): boolean {
  return string(value) && new Set([
    'black',
    'navy',
    'darkblue',
    'mediumblue',
