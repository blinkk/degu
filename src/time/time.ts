 ...
 * @param endTime
 */
export function timeDiffMs(startTime: number, endTime: number): number {
 ...
 * @param utcDate
 */
export function utcDateToLocalTimeZone(utcDate: Date): Date {
 ...
 * ---
 */
export function createLocalTimeZoneDate(localTimeDate: string): Date {
  if (is.safari()) {
 ...
 *
 */
export function pacificTimeToLocalTimeDate(pacificTime: string): Date {
 ...
 *
 */
export function easternTimeToLocalTimeDate(pacificTime: string): Date {
  // First create the time locally.
  // 4 Hour diff.
 ...
 * ```
 */
export function countdown(currentTime: Date, endTime: Date): Object {
